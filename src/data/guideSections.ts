...
export const guideSections: GuideSection[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'After sign-up, wait for an admin to assign your role before accessing modules.',
      'Use the "Employee Portal" link to access the employee login page.',
  ...
  },
  {
    ...
    steps: [
      'The Dashboard is the first page after logging in.',
      'View key financial metrics: total revenue, total expenses, net profit, and outstanding invoices.',
      'Review recent invoices and expenses in the summary cards.',
      'Use the date range filter to adjust the reporting period.',
      'Charts display revenue vs. expenses trends and expense category breakdowns.',
      'Click on any summary card to navigate directly to the relevant module.',
    ],
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      'Duplicate submissions are prevented automatically — if you accidentally click Save twice, only one record is created.',
    ],
  },
  {
    ...
    steps: [
      ...
      'Duplicate invoice submissions are prevented — the system ignores accidental double-clicks or network retries.',
    ],
  },
  {
    ...
    steps: [
      ...
      'Duplicate expense submissions are prevented automatically.',
    ],
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      'Net Salary and Total CTC are automatically rounded to the nearest whole number.',
      ...
      'Duplicate payroll generation is prevented — accidental resubmissions are ignored.',
    ],
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      'Duplicate approval actions are prevented — clicking Approve twice will not process the item twice.',
    ],
  },
  {
    ...
    steps: [
      'When a new user signs up, their account enters "Pending Approval" status.',
      'The user sees a waiting screen until an admin assigns them a role.',
      'Admins can assign roles from the User Management page.',
      'Once a role is assigned, the user can log in and access their permitted modules.',
    ],
  },
  {
  ...
  },
  {
    ...
    steps: [
      'The system uses idempotency keys to prevent duplicate record creation.',
      'When you submit an invoice, expense, bank account, or payroll run, a unique key is generated.',
      'If the same request is sent again (e.g., due to network retry or double-click), the duplicate is ignored.',
      'The Submit button is automatically disabled while a request is in progress.',
      'If a duplicate is detected, you will see a conflict message — simply retry with a fresh submission.',
