...
export default function Login() {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(
        isSignup
          ? t("login.signupFailed") || "Signup failed. Please try again."
          : t("login.loginFailed") || "Login failed. Please check your email and password.",
      );
      console.error(err);
    } finally {
      setLoading(false);
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-sidebar-bg relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16">
          ...
          <h2 className="text-4xl font-bold text-sidebar-foreground mb-4 leading-tight">
            {t("login.tagline1") || "Streamline Your"}
            <br />
            ...
            <div className="bg-card rounded-2xl shadow-lg border border-border p-8">
              <div className="text-center mb-8">
                ...
                <p className="text-muted-foreground mt-2">
                  {isSignup
                    ? t("login.signupSubtitle") || "Start managing your finances today"
                    : t("login.loginSubtitle") || "Sign in to continue to your dashboard"}
                </p>
              </div>
              ...
              <form onSubmit={submit} className="space-y-5">
                ...
                <button type="submit" disabled={loading} className="btn btn-primary btn-lg w-full group">
                  {loading ? (
                    <>
              ...
              <div className="mt-8 text-center">
                ...
                >
                  {isSignup
                    ...
                    : t("login.createAccountLink") || "Create an account"}
                </button>
              </div>
            </div>
